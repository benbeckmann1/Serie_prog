...
namespace RegArchLib {
    ...
    uint cRegArchGradient::GetNParam(void) const
    {
    	return mvNParam ;
    }
    
    uint cRegArchGradient::GetNMeanParam(void) const
    {
    	return mvNMeanParam ;
    }
    
    uint cRegArchGradient::GetNVarParam(void) const
    {
    	return mvNVarParam ;
    }
    
    uint cRegArchGradient::GetNDistrParameter(void) const
    {
